...
You could make a more advanced gallery-implementation by using creating filters for camera-data, with the [EXIF](/17/themes/twig-filters-functions#exif)-function.
...
This should generally be placed before the Twig-structure, or ideally be streamed into the [Asset Manager](/17/themes/asset-manager) in your theme. The effect is to add **[+]** after each parent-item, indicating that it can be opened, which disappears when opened.

Finally, let's add a bit of JavaScript to [handle toggling](https://stackoverflow.com/a/36297446/603387) the *open*-class:

[codesh=js line-numbers="true"]
...
This should always be placed **after** the Twig-structure, also ideally in the [Asset Manager](/17/themes/asset-manager).
...
First, [use the Grav Devtools plugin](/17/themes/theme-tutorial) to create a blank theme, and set Grav to use it in the System settings.
