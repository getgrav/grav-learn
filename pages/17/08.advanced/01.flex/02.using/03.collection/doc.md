...
Returns:
- **[Object](/17/advanced/flex/using/object)** (`object`) Last object
- `false` No objects in the Collection
...
Returns:
- **[Object](/17/advanced/flex/using/object)** (`object`) Next object
...
Parameters:
- **[Object](/17/advanced/flex/using/object)** Object to be added (`object`)
...
Returns:
- **[Object](/17/advanced/flex/using/object)** Removed object (`object`) or `null` if it was not found
...
Parameters:
- **[Object](/17/advanced/flex/using/object)** Object to be removed (`object`)
...
Parameters:
- **[Object](/17/advanced/flex/using/object)** Object to be tested (`object`)
