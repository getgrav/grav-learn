...
**[Flex](/17/advanced/flex/using/flex)** is a container for **Flex Directories**.
...
**[Flex Directory](/17/advanced/flex/using/directory)** keeps a collection of **Flex Objects** of a single **Flex Type**.

Each Directory contains a **Collection** of **Objects** with optional support for **Indexes** to speed up queries to **Storage**.

#### Flex Collection

**[Flex Collection](/17/advanced/flex/using/collection)** is a structure that contains **Flex Objects**.
...
**[Flex Object](/17/advanced/flex/using/object)** is a single instance of some **Flex Type**.

The object represents a single entity. The object gives access to its properties, including any associated data, such as **[Media](/17/content/media)**. Object also knows how to **Render** itself or which **Form** to use to edit its contents. Actions like creating, updating and deleting objects are supported by the object itself.
...
**[Flex Administration](/17/advanced/flex/administration)** is implemented by **Flex Objects Plugin**.
