...
| Option                                | Description                                                       |
| :-----                                | :-----                                                            |
| **Groups** | List of the [groups](/17/admin-panel/accounts/groups) user is part of. |
| **Permissions** | List of all permissions in your site. See [Group Permissions](/17/admin-panel/accounts/groups#permissions). |
[/div]
