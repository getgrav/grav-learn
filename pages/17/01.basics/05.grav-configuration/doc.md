...
| **check:** | |
| ... **method:** | Method to check for updates in pages. Options: `file`, `folder`, `hash` and `none`. [more details](/17/advanced/performance-and-caching#grav-core-caching) |
...
| **collections:** | This contains collections, designated as sub-items. For example: `jquery: system://assets/jquery/jquery-3.x.min.js`. [Read more about this](/17/themes/asset-manager#collections-and-attributes) |
[/div]
...
| **metadata:** | Set default metadata for all your pages, see the [content page headers](/17/content/headers) section for more details |
| **summary:** | |
