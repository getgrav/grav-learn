...
3. Install the **plugin** and **theme dependencies** by using the [Grav CLI application](/17/advanced/grav-cli) `bin/grav`:
...
Please consult the [Troubleshooting](/17/troubleshooting) section for help regarding specific issues.

! If you have issues with file permissions, please check the [Permissions Troubleshooting documentation](/17/troubleshooting/permissions). Also, you could look at the [Hosting Guides documentation](/17/webservers-hosting) that has specific instructions for various hosting environments

## Grav Updates

To keep your site up to date, please read [Updating Grav & Plugins](/17/basics/updates).
