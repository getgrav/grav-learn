...
| `value_type`        | Set to `textarea` to display a [textarea field](/17/forms/forms/fields-available#textarea-field) for entering array values rather than the smaller [text field](/17/forms/forms/fields-available#text-field). |
[/div]
...
| Attribute     | Description                                                                                                |
| :-----        | :-----                                                                                                     |
| `folder` | The folder where the files will be looked up, using a stream or relative to the Grav root. Accepts any value in the [file field destination format](/17/forms/blueprints/how-to-add-file-upload#destination). |
