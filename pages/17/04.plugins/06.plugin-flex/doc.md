...
Flex usages, be in twig or in code, will be only covered for the purpose of this introduction. To understand the power and flexibily of Flex, please read our [dedicated Flex documentation](/17/advanced/flex).
...
Grav 1.7 or later is required. For the purpose of this documentation, we will be using the grav+admin installation, make sure you have it up and running to follow the steps below. See the [installation documentation](/17/basics/installation) to get it ready.
...
To [create a new plugin using the devtools](/17/plugins/plugin-tutorial), the following command is used, the plugin name is myflexplugin:
...
We won't cover all options here, but focus on getting our book object implement. The [extensive Flex blueprints documentation](/17/advanced/flex/custom-types/blueprint) will guide you to go deeper and customize it.
...
The list of all fields types available can be found [here](/17/forms/blueprints/fields-available)
