...
More information on the backup functionality can be found in the [Advanced -> Backups](/17/advanced/backups) section.
...
As outlined in the [Advanced -> Scheduler](/17/advanced/scheduler) section, The scheduler can be monitored via the CLI command.
...
Please refer to the [Advanced -> Scheduler](/17/advanced/scheduler) section, for more detailed information on these options.

## Security

Added in Grav 1.5 is a new security scanner CLI command.  You can run this to quickly scan your contents against the [configured security settings](/17/basics/grav-configuration#security).
