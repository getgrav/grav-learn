...
If this is ok, make sure you're not behind a proxy. If so, [configure it](/17/basics/grav-configuration#system-configuration) in the Grav System configuration and [make sure there are no issues with the connection](/17/troubleshooting/proxy).

Then, [check your permissions](/17/troubleshooting/permissions).
