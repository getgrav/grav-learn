...
1. [Typora](https://typora.io/) - MacOS | Windows | linux - Free, beautiful. The one to get!
2. [MacDown](http://macdown.uranusjr.com/) - MacOS - Free, a simple, lightweight open source Markdown editor.
3. [LightPaper](http://lightpaper.42squares.in/) - MacOS - $9.99, clean, powerful. Our markdown editor of choice on the Mac. **Get 25% OFF with Discount Code: GET_GRAV_25**
4. [MarkDrop](http://culturezoo.com/markdrop/) - MacOS - $5, but super clean and Droplr support built-in.
5. [MarkdownPad](http://markdownpad.com/) - Windows - Free and Pro versions. Even has YAML front-matter support. An excellent solution for Windows users.
6. [Mark Text](https://marktext.github.io/website/) - Free, open source Markdown editor for Windows / Linux / MacOS.
