...
Supports [optimistic concurrency control](/18/api/getting-started#concurrency-control) via the `If-Match` header. Include the ETag from your last GET request to prevent overwriting concurrent changes.
