...
The request body is deep-merged into the existing configuration. Supports [optimistic concurrency control](/18/api/getting-started#concurrency-control) via the `If-Match` header.
