...
3. Install the **plugin** and **theme dependencies** by using the [Grav CLI application](/18/advanced/grav-cli) `bin/grav`:
...
To keep your site up to date, please read [Updating Grav & Plugins](/18/basics/updates).
