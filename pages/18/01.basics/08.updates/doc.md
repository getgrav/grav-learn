...
The preferred method for keeping Grav, Plugins and Themes up to date is to use the **Grav Package Manager (GPM)**. Full information can be found in the [Grav GPM Documentation](/18/advanced/grav-gpm).

We also have **GPM** integrated into our [Administration Panel](/18/admin-panel) plugin which will check, prompt, and automatically install any updates.
...
A detailed guide **[Upgrading from Grav <1.6](/18/advanced/grav-development/grav-15-upgrade-guide)** should help you in the process.
