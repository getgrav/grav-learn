...
See the [API Events](/2/api/events) page for the `onApiFloatingWidgets` contract and the [Developer Guide](/2/api/developer-guide#floating-widgets) for the full widget recipe.
