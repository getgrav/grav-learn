...
api:
    ...
    response_example: '{"data": {"route": "/blog/my-post", "slug": "my-post", "title": "My Post", "template": "default", "language": "en", "content": "# Hello", "media": []}}'
    response_codes:
        - code: '200'
        ...
        - code: '422'
          description: 'Missing or invalid `lang` (including a code that is not a string), multi-language not enabled, no untyped base file exists (page already uses language-suffixed files, use `/translate` instead), a translation file for that language already exists, or target filename collides with the base filename.'
        - code: '500'
