...
The [Markdown output](/2/content/markdown-output) body of a page: the main content region of the page as the theme renders it, with a `# Title` added only when the theme printed none. Defaults to the current page. **Grav 2.1+**
...
The YAML block that opens a page's [Markdown output](/2/content/markdown-output): title, canonical URL, `.md` URL, language, date, description and taxonomy. Defaults to the current page. **Grav 2.1+**
...
The navigation section that closes a page's [Markdown output](/2/content/markdown-output): parent, previous and next pages, and children, each by its `.md` URL. Empty when the page has none. Defaults to the current page. **Grav 2.1+**
...
The whole [Markdown output](/2/content/markdown-output) document of a page: frontmatter, body and navigation, as core's `default.md.twig` renders it. Defaults to the current page. **Grav 2.1+**
...
The absolute `.md` URL of a page, the one its [Markdown output](/2/content/markdown-output) is served from. The home page is linked by its real route rather than `/.md`. Defaults to the current page. **Grav 2.1+**
