...
Converts a fragment of rendered HTML to Markdown, the same conversion Grav's [Markdown output](/2/content/markdown-output) uses for a page: ATX headings, fenced code with its language, tables, absolute URLs, and no forms, scripts or inline SVG. **Grav 2.1+**
