...
For the REST API and Admin Next ways of working with the same data, see [Flex REST API](/2/api/endpoints/flex-objects) and the [Admin Next](/2/advanced/flex) sections.
