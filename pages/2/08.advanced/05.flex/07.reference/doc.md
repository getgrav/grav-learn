...
The **Flex** service is the top-level registry. It knows about every directory that has been enabled (see [Registering a Directory](/2/advanced/flex)) and hands you directories, collections, and objects by name.
